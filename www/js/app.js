  ...
  $app.innerHTML = `
    <div>
      <div class="feed-header">
        ...
        <div class="feed-date-bar" id="date-bar">
          <button class="date-chip ${state.feedTime === ''        ? 'active' : ''}" data-time="">Tous</button>
          <button class="date-chip ${state.feedTime === 'today'   ? 'active' : ''}" data-time="today">Aujourd'hui</button>
          <button class="date-chip ${state.feedTime === 'weekend' ? 'active' : ''}" data-time="weekend">Ce weekend</button>
          <button class="date-chip ${state.feedTime === 'week'    ? 'active' : ''}" data-time="week">Cette semaine</button>
        </div>
        <div class="feed-geo-bar">
          ...
          <button class="filter-icon-btn" id="btn-filter-icon" aria-label="Ouvrir les filtres">
            ...
            <span class="filter-badge ${state.feedCat ? '' : 'hidden'}" id="filter-badge">${state.feedCat ? 1 : ''}</span>
          </button>
        </div>
      </div>
